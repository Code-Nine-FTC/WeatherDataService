...
async def get_station_history(
    ...
    return await DashboardController(session).get_station_history(
        station_id, startDate, endDate
    )
...
@router.get(
    "/last-measures/{station_id}", response_model=BasicResponse[list[StationHistoryItem]]
)
